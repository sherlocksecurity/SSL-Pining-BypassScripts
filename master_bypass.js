setTimeout(function () {
    Java.perform(function () {
        console.log("---");
        console.log(" SherlockSecure Magic - Unpinning Android app...");
        ...
        try {
            ...
            UnverifiedCertError.$init.implementation = function (str) {
                ...
                try {
                    ...
                    console.log(' SherlockSecure Magic -    Attempting to patch automatically...');
        ...
        try {
            ...
            HttpsURLConnection.setDefaultHostnameVerifier.implementation = function (hostnameVerifier) {
                console.log(' SherlockSecure Magic  --> Bypassing HttpsURLConnection (setDefaultHostnameVerifier)');
                return; 
            };
    ...
    PackageManager.getPackageInfo.overload('java.lang.String', 'int').implementation = function(pname, flags) {
        ...
        if (shouldFakePackage) {
            send("SherlockSecure Magic - Bypass root check for package: " + pname);
